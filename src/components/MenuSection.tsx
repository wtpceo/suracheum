...
export default function MenuSection() {
  ...
  const featuredMenus = [
    {
      ...
      includes: "수조육 + 은대구 + 한방 갈비찜 + 돌솥밥 + 계절찬",
    ...
    },
    {
      ...
      includes: "소갈비찜 + 순두부찌개 + 모둠전 + 돌솥밥 + 반찬",
    ...
    },
    {
      ...
      includes: "해산물 + 전복 + 한우갈비 + 능이버섯 + 전복죽 + 특별찬",
  ...
  const allMenus = [
    ...
    },
    {
      ...
      includes: "직화제육 + 된장찌개 + 계절나물 + 돌솥밥 + 반찬",
    ...
    },
    {
      ...
      includes: "제주 흑돼지 + 해물 + 된장찌개 + 돌솥밥 + 반찬",
